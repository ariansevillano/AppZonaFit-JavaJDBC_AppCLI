...
public class Cliente {
    ...
    public Cliente (int id) {
        this.id = id;
    }  //supuestamente este es solo para eliminar co id

    public Cliente(String nombre, String apellido, int membresia) { // este ya vendría a ser agregando
        this.nombre = nombre;
    ...
    public Cliente(int id, String nombre, String apellido, int membresia) {
        this(nombre, apellido, membresia); // así se hace para llamar a otro constructor pero siempre debe ser la 1era linea
        this.id = id;
    }
